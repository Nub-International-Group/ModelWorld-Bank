...
const app = express()
app.use(cors({credentials: true, origin: ['https://bank.nub.international', 'http://127.0.0.1:8081']}))
app.options('*', cors({credentials: true, origin: ['https://bank.nub.international', 'http://127.0.0.1:8081']}))
